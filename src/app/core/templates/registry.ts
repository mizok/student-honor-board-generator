...
export const TEMPLATE_REGISTRY: Readonly<Record<string, TemplateDefinition>> = {
  ...
  'class-ranking': {
    ...
    defaultData: {
      ...
      subtitle: '恭賀同學努力有成',
      schoolRankings: [
        { rank: 1, classNumber: '805', studentName: '張耀文' },
        { rank: 2, classNumber: '901', studentName: '陳映如' },
        { rank: 3, classNumber: '803', studentName: '林志宏' },
        { rank: 4, classNumber: '902', studentName: '吳佳穎' },
        { rank: 5, classNumber: '805', studentName: '黃建勝' },
        { rank: 6, classNumber: '801', studentName: '劉芳儀' },
      ],
      classRankings: [
        { rank: 1, classNumber: '805', studentName: '張耀文' },
        { rank: 2, classNumber: '805', studentName: '王小明' },
        { rank: 1, classNumber: '901', studentName: '陳映如' },
        { rank: 2, classNumber: '901', studentName: '李小華' },
        { rank: 1, classNumber: '803', studentName: '林志宏' },
        { rank: 2, classNumber: '803', studentName: '周雅雯' },
      ],
    },
  },
};
